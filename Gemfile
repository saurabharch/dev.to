...
gem "aws-sdk-lambda", "~> 1.5", ">= 1.5.0" # Just Lambda. For more, install aws-sdk gem
gem "bourbon", "~> 1.4"
...
gem "figaro", "~> 1.1"
gem "flipflop", "~> 2.3", ">= 2.3.1"
gem "fog", "~> 1.42", ">= 1.42.0"
gem "front_matter_parser", "~> 0.1"
gem "gibbon", "~> 3.4", ">= 3.4.4"
gem "google-api-client", "~> 0.19", ">= 0.19.8"
...
gem "recaptcha", "~> 4.6", ">= 4.6.4", require: "recaptcha/rails"
gem "redcarpet", "~> 3.5", ">= 3.5.1"
gem "reverse_markdown", "~> 1.0", ">= 1.0.5"
gem "rolify", "~> 5.2"
gem "rouge", "~> 3.1"
...
gem "sprockets-es6", "~> 0.9", ">= 0.9.2"
gem "staccato", "~> 0.5"
gem "storext", "~> 3.0", ">= 3.0.0"
gem "stream_rails", "~> 2.5", ">= 2.5.2"
gem "stripe", "~> 3.25"
